...
bitflags! {
    pub struct TraceFlags: u32 {
        ...
        const EVENT_ENABLE_PROPERTY_ENABLE_SILOS =              Etw::EVENT_ENABLE_PROPERTY_ENABLE_SILOS;
        const EVENT_ENABLE_PROPERTY_SOURCE_CONTAINER_TRACKING = Etw::EVENT_ENABLE_PROPERTY_SOURCE_CONTAINER_TRACKING;
    }
}
